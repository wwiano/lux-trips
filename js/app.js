(() => {
    ...
    (() => {
        ...
        function formRating() {
            ...
            function initRatings() {
                ...
                function setRatingActiveWidth(index = ratingValue.innerHTML) {
                    ...
                    ratingActive.style.height = `${ratingActiveWidth}%`;
                }
        ...
        function initSliders() {
            if (document.querySelector(".rated__slider")) new core(".rated__slider", {
            ...
            if (document.querySelector(".packages__slider")) new core(".packages__slider", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
